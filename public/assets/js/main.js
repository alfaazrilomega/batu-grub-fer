document.addEventListener('DOMContentLoaded', function () {
    ...
    const dictionary = {
        ...
        profile_text: { id: "Mining Industry Indonesia (Batu Group) adalah BUMN Holding Industri Pertambangan yang mengelola sumber daya mineral strategis Indonesia untuk kemakmuran bangsa.", en: "Mining Industry Indonesia (Batu Group) is the State-Owned Holding for the Mining Industry that manages Indonesia's strategic mineral resources for the nation's prosperity." },
        ...
        sustainability_text: { id: "Keberlanjutan adalah prinsip yang tidak terpisahkan dalam menetapkan strategi, tujuan bisnis, dan operasi sehari-hari Batu Group dan semua anggota Batu Group. Kami menjunjung tinggi prinsip-prinsip keberlanjutan dengan integritas penuh untuk memastikan bahwa apa yang kami kelola saat ini dapat memberikan manfaat berkelanjutan dan lestari untuk masa depan yang lebih cerah bagi semua orang.", en: "Sustainability is an integral principle in establishing the strategy, business objectives, and daily operations of Batu Group and all Batu Group members. We uphold sustainability principles with full integrity to ensure that what we manage today can provide sustainable and lasting benefits for a brighter future for everyone." },
        sustainability_people: { id: "Insan Batu Group", en: "Batu Group People" },
        ...
        news1_title: { id: "Batu Group Dorong Inovasi Digital di Sektor Pertambangan", en: "Batu Group Pushes for Digital Innovation in the Mining Sector" },
        news_cta: { id: "Selengkapnya", en: "Read More" },
        news2_date: { id: "15 Des 2025", en: "Dec 15, 2025" },
        news2_title: { id: "Program Pemberdayaan Masyarakat oleh Batu Group Raih Penghargaan", en: "Batu Group's Community Empowerment Program Wins Award" },
        news3_date: { id: "12 Des 2025", en: "Dec 12, 2025" },
        news3_title: { id: "Ekspansi Hilirisasi, Batu Group Bangun Smelter Baru", en: "Downstream Expansion, Batu Group Builds a New Smelter" },
        members_heading: { id: "Anggota Kami", en: "Our Members" },
        members_text: { id: "Batu Group adalah wajah Indonesia yang kaya akan sumber daya dan kaya akan talenta dari putra-putri Indonesia yang siap berkarya dan bersinergi memberikan yang terbaik bagi negeri.", en: "Batu Group is the face of an Indonesia rich in resources and rich in talent from the sons and daughters of Indonesia who are ready to work and synergize to give the best for the country." },
        ...
        footer_copyright: { id: "&copy; 2025 Batu Group. All Rights Reserved.", en: "&copy; 2025 Batu Group. All Rights Reserved." }
    };
